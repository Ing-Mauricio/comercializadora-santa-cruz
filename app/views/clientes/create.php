<div class="topbar">
    <div>
        <h2>Nuevo Cliente</h2>
        <div class="breadcrumb-sub">Registrar un nuevo cliente en el sistema</div>
    </div>
    ...
    <form action="<?= BASE_URL ?>/clientes/guardar" method="POST">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="nit_ci" class="form-control form-control-dark">
            </div>
            <div class="col-md-6">
        ...
        <button type="submit" class="btn btn-gradient"><i class="bi bi-save me-1"></i> Guardar Cliente</button>
